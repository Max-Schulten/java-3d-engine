    ...
    public static void main(String[] args) {
        ...
        JPanel renderPanel = new JPanel() {
          public void paintComponent(Graphics g) {
              ...
              // Adding the transform functionality so sliders change view points
              double heading = Math.toRadians(headingSlider.getValue());

              Matrix3 headingTransform = new Matrix3(
                      new double[] {
              ...
              // Use barycentric coordinates to draw the pixels in the triangle with color
              ...
              for (Triangle t : tris) {
                  ...
                  // Iterate over all the points, if they are in the triangle draw them
